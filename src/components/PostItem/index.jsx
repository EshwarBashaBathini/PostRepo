  ...
  return (
    <li data-testid="post-item" className="list-item">
      <div className="profile-container">
        <img
          src="https://res.cloudinary.com/dtc3rf1du/image/upload/v1720272379/IMG20230625162900_2_nknhvx.jpg"
          alt="User Profile"
          className="user-img"
        />
      ...
      {!isEdit && (
        <>
          ...
          <div className="btn-container">
            <button type="button" onClick={onChangeBtn} className="edit-btn">
              Edit
            </button>
