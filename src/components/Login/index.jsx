    ...
    return(
        <div className='login-bg-container'>
            <form className='form-container' onSubmit={onLoginSubmit}>
                ...
                <h2 className='login-head'> <MdLocalPostOffice size={20}/> My Posts</h2>
                
                <label htmlFor='username'className='label-login'>Username</label>
                <input type='text' id='username' value={username} onChange={onUsernameChange} className='input-login' placeholder='eshwar' />
                <label htmlFor='password'className='label-login'>Password</label>
                <input type='password' className='input-login' value={passoword} onChange={onPasswordChange} id='password' placeholder='eshwar@123' />
